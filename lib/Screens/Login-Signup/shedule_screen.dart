          ...
          children: [
            Text(
              Provider.of<UiProvider>(context)
                  .getLocale()
                  .keys[Provider.of<UiProvider>(context).language]?["64"]??"Appointments",
                          ...
                          children: [
                            Padding(
                              ...
                              child: TabBar(
                                ...
                                tabs:  [
                                  Tab(text: Provider.of<UiProvider>(context)
                                      .getLocale()
                                      .keys[Provider.of<UiProvider>(context).language]?["64"]??"Appoiements"),
                                  Tab(text: Provider.of<UiProvider>(context)
                                      .getLocale()
                                      .keys[Provider.of<UiProvider>(context).language]?["65"]??"Upcoming"),
                                  Tab(text: Provider.of<UiProvider>(context)
                                      .getLocale()
                                      .keys[Provider.of<UiProvider>(context).language]?["66"]??"Completed"),
                                ],
                              ),
                            ),
                          ],
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
        ...
        if (userAppointments.isEmpty) {
          return Center(child: Text(Provider.of<UiProvider>(context)
              .getLocale()
              .keys[Provider.of<UiProvider>(context).language]?["67"]??'No appointments found'));
        }
